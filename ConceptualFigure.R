...
AnthroUpstreamLossGW<- "07139500"  # Arkansas River near Dodge City - need the correct USGS gauge number
AgwStart<-as.Date("2000-10-01") #2000-10-01 ?? 
AgwEnd<-as.Date("2001-10-01") #2001-10-01


AnthroConveyance<- "08358400" #Rio Grande Floodway
AnthroConveyance<- "08358300" #Rio Grande Conveyance
